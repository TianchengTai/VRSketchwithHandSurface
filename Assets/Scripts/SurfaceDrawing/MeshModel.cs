...
namespace VRPainting
{
    public class MeshModel:MonoBehaviour
    {
        ...
        {
            GameObject surface;
            List<CP> cpList = Line2CPList(line, center, true);//��Ĭ-������˹-�տ��㷨��ֱ�߼�
            //List<CP> cpList = RamerDouglasPeucker.Reduce(Line2CPList(line,center,true), tolerance);//��Ĭ-������˹-�տ��㷨��ֱ�߼�
            Pipeline.RotateAndRender(out surface, cpList, axis, angle, 2, 2, line.loop);//��ת��
